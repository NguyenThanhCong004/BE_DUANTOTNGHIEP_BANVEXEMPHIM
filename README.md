...
## 🚀 Chạy nhanh
1. JDK 17, Maven; cấu hình `src/main/resources/application.properties` hoặc `.env` (SQL Server).
...
## 📦 Gói chính
Spring Boot **3.5.11**, Spring Security + **JWT**, Spring Data JPA (**SQL Server**), SpringDoc OpenAPI, PayOS, Mail, ZXing QR/barcode (theo `pom.xml`).
